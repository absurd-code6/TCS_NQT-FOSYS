...
def mergeAlternately(word1: str, word2: str) -> str:
    ...
    for a, b in zip(word1, word2): # This unpacks the package into two 
#separate variables, 'a' and 'b'
        res.append(a) # Adds the letter from the first string
        res.append(b) # Adds the letter from the second string
