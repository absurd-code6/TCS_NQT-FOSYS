...
Output: 19
Explanation: Maximum amount he can get by looting 1st, 3rd, 5th and 7th house, 
which is 6 + 1 + 8 + 4 = 19.
Input: arr[] = [5, 3, 4, 11, 2]
Output: 16
Explanation: Maximum amount he can get by looting 1st and 4th house, which is 
5 + 11 = 16.
Constraints:
1 ≤ arr.size() ≤ 105
1 ≤ arr[i] ≤ 104'''
...
def Stickler(house_prices):
    ...
    prev2=house_prices[0]
    prev1=max(house_prices[0],house_prices[1])
