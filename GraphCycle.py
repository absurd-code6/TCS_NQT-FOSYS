...
It provides specialized container datatypes beyond Python’s basic dict, 
list, set, and tuple.
Some examples in collections are:
...
Think of collections as a “toolbox” of enhanced data structures
defaultdict
This is a special kind of dictionary.

Normal Python dictionaries raise a KeyError if you try to access a key that doesn’t exist:

d = {}
d['a']  # KeyError

defaultdict lets you define a default value for missing keys:

from collections import defaultdict

d = defaultdict(int)  # default value is 0
print(d['a'])  # 0 instead of KeyError
d['a'] += 1
print(d['a'])  # 1
You provide a callable (like a function) that returns the default value:
int → 0
list → []
set → set()'''
from collections import defaultdict
class Graph(): # same as class Graph:
